...
requorvid: {
    ...
    types: ["Ghost", "Normal"],
    genderRatio: { M: 0.5, F: 0.5 },
    baseStats: { hp: 85, atk: 65, def: 70, spa: 110, spd: 75, spe: 95 },
...
snatchet: {
    ...
    types: ["Bug", "Fire"],
    genderRatio: { M: 0.5, F: 0.5 },
    baseStats: { hp: 40, atk: 100, def: 90, spa: 85, spd: 70, spe: 75 },
...
honq: {
    ...
    types: ["Fairy"],
    genderRatio: { M: 0.5, F: 0.5 },
    baseStats: { hp: 90, atk: 120, def: 110, spa: 40, spd: 60, spe: 100 },
...
helpip: {
    ...
    abilities: {0: "Sturdy", H: "Guard Dog"},
    weightkg: 26.6,
    color: "Gray",
    eggGroups: ["Field"],
    heightm: 0.9,
...
freeks: {
    ...
    abilities: {0: "Technician", 1: "Flame Body", H: "Arsonist"},
    weightkg: 1.5,
    color: "Red",
    eggGroups: ["Undiscovered"],
    heightm: 0.3,
